...
# 14 "MCAL/EUSART/mcal_EUSART.h" 2
...
# 13 "MCAL/EUSART/../Interrupts/mcal_interrupt_config.h"
# 1 "MCAL/EUSART/../Interrupts/../std_libraries.h" 1
# 11 "MCAL/EUSART/../Interrupts/../std_libraries.h"
...
# 11 "MCAL/EUSART/../Interrupts/../std_libraries.h" 2
...
# 13 "MCAL/EUSART/../Interrupts/../std_libraries.h" 2
# 13 "MCAL/EUSART/../Interrupts/mcal_interrupt_config.h" 2

# 1 "MCAL/EUSART/../Interrupts/../mcal_std_types.h" 1
# 20 "MCAL/EUSART/../Interrupts/../mcal_std_types.h"
...
# 13 "MCAL/EUSART/../GPIO/hal_gpio.h"
# 1 "MCAL/EUSART/../GPIO/../device_config.h" 1
# 11 "MCAL/EUSART/../GPIO/../device_config.h"
# 1 "MCAL/EUSART/../Interrupts/../compiler.h" 1
# 11 "MCAL/EUSART/../GPIO/../device_config.h" 2
# 13 "MCAL/EUSART/../GPIO/hal_gpio.h" 2


# 1 "MCAL/EUSART/../GPIO/hal_gpio_cfg.h" 1
# 15 "MCAL/EUSART/../GPIO/hal_gpio.h" 2
# 42 "MCAL/EUSART/../GPIO/hal_gpio.h"
typedef enum{
   GPIO_LOW=0,
   GPIO_HIGH
}logic_et;
...
static __attribute__((inline)) Std_ReturnType async_Rx_config(const uart_rx_config_st *_rx_obj );
...
static __attribute__((inline)) uint8_t calc_parity_odd(uint8_t data);
static __attribute__((inline)) uint8_t calc_parity_even(uint8_t data);
...
Std_ReturnType EUSART_Async_Transmit_Data(const uart_config_st *_eusart_obj , uint16_t data)
{
    ...
    else
    {
        ...
        if(1 == _eusart_obj->tx_config.tx_9th_bit_en)
        {


            if(0 == _eusart_obj->tx_config.uart_tx_9th_bit_role)
            {

                TXSTAbits.TX9D = (__bit) (data >> 8);

            }
            else if(1 == _eusart_obj->tx_config.uart_tx_9th_bit_role)
            {

                TXSTAbits.TX9D = (__bit) calc_parity_even( (uint8_t) data);

            }
            else if (2 == _eusart_obj->tx_config.uart_tx_9th_bit_role)
            {
        ...
        if(1 == PIR1bits.RCIF)
        {
            if(1 == _eusart_obj->rx_config.rx_9th_bit_en)
            {
                ...
                *data = l_temp_data ;
                ...
                else if(1 == _eusart_obj->rx_config.uart_rx_9th_bit_role)
                {
                ...
                else if (2 == _eusart_obj->rx_config.uart_rx_9th_bit_role)
                {
...
static Std_ReturnType async_Tx_config(const uart_tx_config_st *_tx_obj )
{
    ...
    else
    {
        if(1 == _tx_obj->tx_enable)
        {
            ...
            else if (0 == _tx_obj->tx_9th_bit_en )
            {
                TXSTAbits.TX9 = 0 ;
            }
            else {}
    ...
    else
    {
        if(1 == _rx_obj->rx_enable)
        {
            ...
            if(1 == _rx_obj->rx_9th_bit_en )
            {
                ...
                else if (0 == _rx_obj->rx_9th_bit_en )
            {
                RCSTAbits.RX9 = 0 ;
            }
            else {}
