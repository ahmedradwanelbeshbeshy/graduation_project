...
Std_ReturnType CCP_Is_Captured_Data_Ready(uint8 *_capture_status){
    Std_ReturnType ret = E_NOT_OK;
...
Std_ReturnType CCP_Is_Compare_Complete(uint8 *_compare_status){
    Std_ReturnType ret = E_NOT_OK;
